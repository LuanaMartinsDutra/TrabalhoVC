...
def labelDraw(image,detect, color_rec = (255, 255, 0), rec_width = 4 , font = cv2.FONT_HERSHEY_COMPLEX_SMALL, width_font = 1, color_font = (139,0,139)):
	for det in detect:
		x,y,x2,y2 = det[:4]
